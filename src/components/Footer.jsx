        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/80">
            <li className="flex items-center gap-2">
              ...
              <a href={site.phones.mobileHref} className="hover:text-white">
                (31) 98788-1993
              </a>
              <span className="text-white/40">/</span>
              <a href={site.phones.landlineHref} className="hover:text-white">
                3632-4433
              </a>
            </li>
            <li className="flex items-center gap-2">
              <Icon name="whatsapp" className="h-4 w-4 text-brand-orange" />
              <a href={site.whatsapp.href} target="_blank" rel="noreferrer" className="hover:text-white">
                Conversar no WhatsApp
              </a>
            </li>
            <li className="flex items-center gap-2">
              <Icon name="instagram" className="h-4 w-4 text-brand-orange" />
              <a href={site.instagram.url} target="_blank" rel="noreferrer" className="hover:text-white">
